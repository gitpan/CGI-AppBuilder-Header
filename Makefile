# This Makefile is for the CGI::AppBuilder::Header extension to perl.
#
...
#     DISTNAME => q[CGI-AppBuilder-Header-0.12.tar.gz]
#     NAME => q[CGI::AppBuilder::Header]
#     PREREQ_PM => { Test::More=>q[0.45], Test::Harness=>q[0.1], CGI::AppBuilder=>q[0.11] }
#     VERSION => q[0.12]
#     test => { TESTS=>q[t/ab_Header.t] }
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = CGI::AppBuilder::Header
NAME_SYM = CGI_AppBuilder_Header
VERSION = 0.12
...
DISTNAME = CGI-AppBuilder-Header-0.12.tar.gz
DISTVNAME = CGI-AppBuilder-Header-0.12.tar.gz-0.12
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         CGI-AppBuilder-Header-0.12.tar.gz' >> META.yml
